...
public class PeopleControllerTest {
    ...
    void shouldHavePaginationOnFetchAll() throws Exception {
        ...
        mockMvc.perform(get("/people").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andExpect(jsonPath("$.pagination.currentPage").value(0))
    ...
    void shouldReturnBadRequestWithErrors() throws Exception {
        ...
        mockMvc.perform(post("/people").contentType(MediaType.APPLICATION_JSON).content("""
                {
                    "name": "R2-D2",
                    "height": "50",
                    "mass": "400",
